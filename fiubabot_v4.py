...
Original file is located at
    https://colab.research.google.com/drive/1KpV4hD2yugZYkvVoZQ3jA1c8mN3yR4eU
"""

#Librerias Telegram
#https://core.telegram.org/bots/samples
#Token: 7650856004:AAF1-vg1nzcsIswSrUhjmvAvP6FbWVP3IhE
...
# Autenticar y conectar con Google Sheets
...
#BAJAMOS LAS INFORMACIÓN DEL DRIVE - ¿NECESITAMOS QUE ESTA SECCIÓN SE EJECUTE CADA VEZ QUE SE HACE UNA CONSULTA, POR LO QUE LA VAMOS A TENER QUE MOVER
#A LA SECCIÓN DE 'DEF PRUEBA_CHATBOT'?
...
#Bajar tabla de aulas, y de horarios, y de códigos de materia
...
# Clasificador de preguntas con embeddings semánticos
...
# Función para buscar el AULA de una asignatura con NLP y coincidencia flexible
...
# Función para buscar el HORARIO de una asignatura con NLP y coincidencia flexible
...
# Función para buscar un PROCESO de la facultad
...
"""# **CONEXIÓN CON BOT TELEGRAM - Si queremos que el programa funcione, tenemos que tener esto en ejecución**"""
...
# Bot token
BOT_TOKEN = '7650856004:AAF1-vg1nzcsIswSrUhjmvAvP6FbWVP3IhE'
